...
namespace LCI.IDP.Services
{
    public class LocalUserService : ILocalUserService
    {
        ...
        Task<IEnumerable<UserClaim>> ILocalUserService.GetUserClaimsBySubjectAsync(string subject)
        {
            throw new NotImplementedException();
        }

        Task<User> ILocalUserService.GetUserByUserNameAsync(string userName)
        {
            throw new NotImplementedException();
        }

        Task<User> ILocalUserService.GetUserBySubjectAsync(string subject)
        {
            throw new NotImplementedException();
        }
    }
